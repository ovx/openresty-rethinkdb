...
do
  local _base_0 = {
    ...
    remove_listener = function(self)
      ...
      return self.emitter.remove_listener()
    end,
    remove_all_listeners = function(self)
      if not self.emitter then
        self:_make_emitter()
        set_immediate(function(self)
          return self:_each(self._each_cb)
      ...
      return self.emitter.remove_all_listeners()
    end,
    set_max_listeners = function(self)
      if not self.emitter then
        self:_make_emitter()
        set_immediate(function(self)
          return self:_each(self._each_cb)
      ...
      return self.emitter.set_max_listeners()
    end,
    ...
    _each_cb = function(self, err, data)
      if err then
